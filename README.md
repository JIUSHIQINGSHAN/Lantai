...
- [ ] v0.16 主轴：从检索竞争转向“记忆生命周期质量”（写入准确性 / 冲突可审计 / 选择性遗忘 / 可回滚）
- [ ] v0.16 重点：MCP 工具面与客户端矩阵扩展、变化追踪可解释性、控制台生命周期闭环
- [ ] 中期差异化：遗忘质量评测体系、中文评测集与对外报告、reflect/autodream + 人工裁决协同（见 `docs/plans/roadmap-2026-09-v016.md`）
