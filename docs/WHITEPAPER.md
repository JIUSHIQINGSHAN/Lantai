...
- **ADR 决策记录**：`docs/adr/0001–0019`，覆盖门面铁律、零硬编码、缓冲键、基础设施栈、遗忘语义、Hook 契约、MCP 形态、FTS5 接入、直存、冲突层、技能资产、场景层、命名体系、mem 命令、provenance、卸载、Wiki、导入、三态去重结构判别；
