...
Guanzhi Wang 1,2, Yuqi Xie 3, Yunfan Jiang 4*, Ajay Mandlekar 1*, Chaowei Xiao 1,5, Yuke Zhu 1,3, Linxi "Jim" Fan 1, Anima Anandkumar 1,2
...
![refer to caption](/html/2305.16291/assets/figures/main_experiment_fig.png)
 [图注]  Figure 1 :  Voyager  discovers new Minecraft items and skills continually by self-driven exploration, significantly outperforming the baselines. X-axis denotes the number of prompting iterations.
...
![refer to caption](/html/2305.16291/assets/x1.png)
 [图注]  Figure 2 :  Voyager  consists of three key components: an automatic curriculum for open-ended exploration, a skill library for increasingly complex behaviors, and an iterative prompting mechanism that uses code as action space.
...
Voyager is made possible through three key modules (Fig. 2): 1) an automatic curriculum that maximizes exploration; 2) a skill library for storing and retrieving complex behaviors; and 3) a new iterative prompting mechanism that generates executable code for embodied control.
...
![refer to caption](/html/2305.16291/assets/x2.png)
 [图注]  Figure 3 :  Tasks proposed by the automatic curriculum. We only display the partial prompt for brevity. See Appendix, Sec.  A.3  for the full prompt structure.
...
The curriculum unfolds in a bottom-up fashion, allowing for considerable adaptability and responsiveness to the exploration progress and the agent’s current state (Fig. 3). As Voyager progresses to harder self-driven goals, it naturally learns a variety of skills, such as “mining a diamond”.

The input prompt to GPT-4 consists of several components:

1. (1) Directives encouraging diverse behaviors and imposing constraints, such as “My ultimate goal is to discover as many diverse things as possible ... The next task should not be too hard since I may not have the necessary resources or have learned enough skills to complete it yet.”;

1. (2) The agent’s current state, including inventory, equipment, nearby blocks and entities, biome, time, health and hunger bars, and position;

1. (3) Previously completed and failed tasks, reflecting the agent’s current exploration progress and capabilities frontier;

1. (4) Additional context: We also leverage GPT-3.5 to self-ask questions based on the agent’s current state and exploration progress and self-answer questions. We opt to use GPT-3.5 instead of GPT-4 for standard NLP tasks due to budgetary considerations.

### 2.2 Skill Library

![refer to caption](/html/2305.16291/assets/x3.png)
 [图注]  Figure 4 :
...
1. (1) Guidelines for code generation, such as “Your function will be reused for building more complex functions. Therefore, you should make it generic and reusable.”;

1. (2) Control primitive APIs, and relevant skills retrieved from the skill library, which are crucial for in-context learning [36, 37, 38] to work well;

1. (3) The generated code from the last round, environment feedback, execution errors, and critique, based on which GPT-4 can self-improve (Sec. 2.3);

1. (4) The agent’s current state, including inventory, equipment, nearby blocks and entities, biome, time, health and hunger bars, and position;

1. (5) Chain-of-thought prompting [46] to do reasoning before code generation.
...
![refer to caption](/html/2305.16291/assets/x5.png)
 [图注]  Figure 6 :  Self-verification examples. We only display the partial prompt for brevity. See Appendix, Sec.  A.5  for the full prompt structure.
...
| ReAct [29] | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ |
| Reflexion [30] | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ |
| AutoGPT [28] | $92\pm 72$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | $94\pm 72$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | $135\pm 103$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | N/A $(\nicefrac{{0}}{{3}})$ |
| Voyager w/o Skill Library | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{7\pm 2}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{9\pm 4}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | $29\pm 11$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | N/A $(\nicefrac{{0}}{{3}})$ |
| Voyager (Ours) | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{6\pm 2}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{11\pm 2}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{21\pm 7}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{102}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{1}}{{3}})}}$ |
...
![refer to caption](/html/2305.16291/assets/figures/map_fig.png)
 [图注]  Figure 7 :  Map coverage: bird’s eye views of Minecraft maps.  Voyager  is able to traverse  $2.3\times$  longer distances compared to baselines while crossing diverse terrains.
...
| Reflexion [30] | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ |
| AutoGPT [28] | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ |
| AutoGPT [28] w/ Our Skill Library | 39 $(\nicefrac{{1}}{{3}})$ | 30 $(\nicefrac{{1}}{{3}})$ | N/A $(\nicefrac{{0}}{{3}})$ | 30 $(\nicefrac{{2}}{{3}})$ |
| Voyager w/o Skill Library | 36 $(\nicefrac{{2}}{{3}})$ | $30\pm 9$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | $27\pm 9$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | $26\pm 3$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ |
| Voyager (Ours) | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{19\pm 3}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{18\pm 7}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{21\pm 5}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ | ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{18\pm 2}}$ ${\color[rgb]{0.09,0.45,0.27}\definecolor[named]{pgfstrokecolor}{rgb}{0.09,0.45,0.27}\mathbf{(\nicefrac{{3}}{{3}})}}$ |
...
![refer to caption](/html/2305.16291/assets/figures/downstream_fig.png)
 [图注]  Figure 8 :  Zero-shot generalization to unseen tasks. We visualize the intermediate progress of each method on two tasks. See Appendix, Sec.  A.3  for the other two tasks. We do not plot ReAct and Reflexion since they do not make any meaningful progress.
...
![refer to caption](/html/2305.16291/assets/figures/ablation_fig.png)
 [图注]  Figure 9 :  Left: Ablation studies for the automatic curriculum, skill library, and GPT-4.  GPT-3.5 means replacing GPT-4 with GPT-3.5 for code generation.  Voyager  outperforms all the alternatives, demonstrating the critical role of each component.  Right: Ablation studies for the iterative prompting mechanism.   Voyager  surpasses all the other options, thereby highlighting the essential significance of each type of feedback in the iterative prompting mechanism.

![refer to caption](/html/2305.16291/assets/figures/human_fig.png)
 [图注]  Figure 10 :  Voyager  builds 3D structures with human feedback. The progress of building designs that integrate human input is demonstrated from left to right.
...
1. (1) Human as a critic (equivalent to Voyager’s self-verification module): humans provide visual critique to Voyager, allowing it to modify the code from the previous round. This feedback is essential for correcting certain errors in the spatial details of a 3D structure that Voyager cannot perceive directly.

1. (2) Human as a curriculum (equivalent to Voyager’s automatic curriculum module): humans break down a complex building task into smaller steps, guiding Voyager to complete them incrementally. This approach improves Voyager’s ability to handle more sophisticated 3D construction tasks.
...
AutoGPT [28] is a popular tool that automates NLP tasks by crafting a curriculum of multiple subgoals for completing a high-level goal while incorporating ReAct [29]’s reasoning and acting loops.
...
[图注]  Pseudocode 1:  Voyager  algorithm.
...
1. (1) Directives encouraging diverse behaviors and imposing constraints (so that the proposed task is achievable and verifiable): See Sec. A.3.4 for the full prompt;
...
1. (3) Previously completed and failed tasks;

1. (4) Additional context: See Sec. A.3.2;

1. (5) Chain-of-thought prompting [46] in response: We request GPT-4 to first reason about the current progress and then suggest the next task.
...
[图注]  Table A.1 :  Warm-up schedule for automatic curriculum.

#### A.3.4 Full Prompt

[图注]  Prompt 1:  Full system prompt for automatic curriculum. The list of question-answer pairs represents the additional context.
...
[图注]  Prompt 2:  Full system prompt for asking questions. We provide both good and bad examples as few-shot exemplars.
...
[图注]  Prompt 3:  Full system prompt for answering questions. Context represents the optional content from a wiki knowledge base.
...
1. (1) Guidelines for code generation: See Sec A.4.2 for the full prompt;
...
1. (4) Retrieved skills from the skill library;

1. (5) Generated code from the last round;

1. (6) Environment feedback: The chat log in the prompt;

1. (7) Execution errors;

1. (8) Critique from the self-verification module;

1. (9) The agent’s current state: See Sec. A.3.1 for each element of the agent’s state;

1. (10) Task proposed by the automatic curriculum;

1. (11) Task context: We prompt GPT-3.5 to ask for general suggestions about how to solve the task. In practice, this part is handled by the automatic curriculum since it has a systematic mechanism for question-answering (Sec. A.3.2);

1. (12) Chain-of-thought prompting [46] in response: We ask GPT-4 to first explain the reason why the code from the last round fails, then give step-by-step plans to finish the task, and finally generate code. See Sec. A.4.2 for the full prompt.

#### A.4.2 Full Prompt

[图注]  Prompt 4:  Full system prompt for code generation.
...
[图注]  Prompt 5:  Full system prompt for generating function descriptions. This is used when adding a new skill to the skill library. We give a one-shot example in the prompt.
...
[图注]  Skill library example 1:  craftWoodenPlanks.
...
[图注]  Skill library example 2:  mineTenCobbledDeepslateBelowY0.
...
[图注]  Skill library example 3:  smeltFiveRawIronV2.
...
[图注]  Skill library example 4:  fillBucketWithWater.
...
[图注]  Skill library example 5:  catchFiveFishSafely.
...
1. (1) The agent’s state: We exclude other blocks that are recently seen and nearby entities from the agent’s state since they are not useful for assessing the task’s completeness. See Sec. A.3.1 for each element of the agent’s state;

1. (2) Task proposed by the automatic curriculum;

1. (3) Task context: We prompt GPT-3.5 to ask for general suggestions about how to solve the task. In practice, this part is handled by the automatic curriculum since it has a systematic mechanism for question-answering (Sec. A.3.2);

1. (4) Chain-of-thought prompting [46] in response: We request GPT-4 to initially reason about the task’s success or failure, then output a boolean variable indicating the task’s outcome, and finally provide a critique to the agent if the task fails.

1. (5) Few-shot examples for in-context learning [36, 37, 38].

#### A.5.2 Full Prompt

[图注]  Prompt 6:  Full system prompt for self-verification.
...
[图注]  Table A.2 :  System-level comparison between  Voyager  and prior works.
...
[图注]  Table A.3 :  Comparison between  Voyager  and baselines.
...
![refer to caption](/html/2305.16291/assets/appendix/figures/mc_icons_fig.png)
 [图注]  Figure A.1 :  Minecraft item icons with corresponding names.
...
![refer to caption](/html/2305.16291/assets/appendix/figures/map_traj_fig.png)
 [图注]  Figure A.2 :  Map coverage: Two bird’s eye views of Minecraft maps.  Voyager  is able to traverse  $2.3\times$  longer distances compared to baselines while crossing diverse terrains. Trajectories are plotted based on the positions where each agent interacts with GPT-4.

Agent trajectories for map coverage are displayed in Fig. A.2. Fig. 7 is plotted based on Fig. A.2 by drawing the smallest circle enclosing each trajectory.
...
![refer to caption](/html/2305.16291/assets/appendix/figures/downstream_other_fig.png)
 [图注]  Figure A.3 :  Zero-shot generalization to unseen tasks. We visualize the intermediate progress of each method on the other two tasks. We do not plot ReAct and Reflexion since they do not make any meaningful progress.
...
[图注]  Table A.4 :  Skill retrieval accuracy.
...
![refer to caption](/html/2305.16291/assets/appendix/figures/model_variations.png)
 [图注]  Figure A.4 :  Voyager ’s performance with GPT-4-0314 and GPT-4-0613.
