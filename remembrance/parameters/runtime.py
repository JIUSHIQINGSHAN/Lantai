...
def check_shadow_due() -> list:
    ...
    """
    from remembrance.core.settings import settings as _s
    from remembrance.parameters.shadow import shadow_is_due
    from remembrance.parameters.trust_models import ShadowWindow
...
def _evaluate_one_window(window, *, auto_rollback: bool = True) -> dict:
    ...
    """
    from remembrance.parameters.shadow import evaluate_window
    from remembrance.parameters.trust_models import ShadowWindow
...
def _run_shadow_dry_run(session, window, *, base: bool) -> dict:
    ...
    from remembrance.eval.runner import run_dry_run
...
def _rollback_snapshot(session, window) -> None:
    ...
    from remembrance.models.tables import ParamOverride
    from remembrance.parameters.registry import get_registry_version
    from remembrance.parameters.validation import snapshot_hash
