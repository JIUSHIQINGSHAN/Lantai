...
def test_acl_search_filters_results(client, setup_keys):
    ...
    with patch(
        "lantai.api.routes_search.relevance_check",
...
def test_acl_write_rejects_out_of_bound_lane(client, setup_keys):
    ...
    resp = client.post(
        ...
        json={
            "title": "Test",
            "content": "This is a long enough content to pass validation for rule",
            "lane": "rule",
        },
    )
    print(resp.json())
    ...
    resp_ok = client.post(
        ...
        json={
            "title": "Test",
            "content": "This is a long enough content to pass validation for fact",
            "lane": "fact",
        },
    )
